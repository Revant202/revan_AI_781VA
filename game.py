...
import Player1 # Player2 is the name of the second bot.
...
It corresponds to the variable B in the move() function in the class 'player' defined in the bots Player1.py, Player2.py, Player3.py, and Player5.py.
...
def main():
    ...
    p = [Player1.player(), Player1.player()]
...
def score_tab(s,font,SCREEN):
        ...
        SCREEN.fill(pygame.Color("black"),  (80,WINDOW_HEIGHT+10,150,WINDOW_HEIGHT+30) )
